...
Alpha t บาร์ แล้วเราก็จะลดรูป กลายเป็นสูตรข้างล่าง ก็จะ Generate x(t) ใดๆ ในเวลาไหนก็ได้ จาก รูป Time steps 0 ไม่ต้องรอกระบวนการตรงกลางเลย เพราะถ้าทำอย่างงั้นเทรนด์ปีนึงก็ไม่เสร็จ

Random noise จาก Distribution ก็ Generate ได้เลย อยากได้ Time steps ตรงไหน
![image](https://github.com/user-attachments/assets/c964ee49-ac2f-497f-901a-428e2e4ac3f0)

แต่ความยากอยู่ที่ Backward

![image](https://github.com/user-attachments/assets/b9ee9584-ef97-4204-908a-a9b0e6fa4015)

มันอาจจะมี Bayes' rule
